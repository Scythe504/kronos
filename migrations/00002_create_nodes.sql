...
CREATE TABLE IF NOT EXISTS nodes (
  ...
  task_unit VARCHAR(64) NOT NULL,
  allowed_slugs VARCHAR(255)[],
...
CREATE INDEX IF NOT EXISTS index_machine_id ON nodes (machine_id);
-- +goose Down
DROP INDEX IF EXISTS index_machine_id;
